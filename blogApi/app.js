...
var schedule = require('./utill/schedule')
...
app.use(function(req, res, next) {
  ...
  res.header("Access-Control-Allow-Headers", 'Origin,X-XSRF-TOKEN,X-Requested-With,Content-Type,Accept,content-type,application/json,Authorization');
  next();
});
